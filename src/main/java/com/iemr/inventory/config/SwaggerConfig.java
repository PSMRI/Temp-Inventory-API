 ...
 *
 * private ApiInfo metaData() { ApiInfo apiInfo = new ApiInfo("Inventory API",
 * "A medicine inventory management and dispensing unit that helps in distributing the medicine to the patients as per the prescription."
