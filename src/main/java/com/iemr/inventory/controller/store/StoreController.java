...
public class StoreController {
	...
	@CrossOrigin()
	@RequestMapping(value = "/createStore", headers = "Authorization", method = {
	...
	@CrossOrigin()
	@RequestMapping(value = "/editStore", headers = "Authorization", method = {
			RequestMethod.POST }, produces = { "application/json" })
	...
	@CrossOrigin()
	@RequestMapping(value = "/getAllStore/{providerServiceMapID}", headers = "Authorization", method = { RequestMethod.POST }, produces = {
			"application/json" })
	...
	@CrossOrigin()
	@RequestMapping(value = "/getAllActiveStore", headers = "Authorization", method = { RequestMethod.POST }, produces = {
			"application/json" })
	...
	@CrossOrigin()
	@RequestMapping(value = "/getMainFacility", headers = "Authorization", method = {
			RequestMethod.POST }, produces = { "application/json" })
	...
	@CrossOrigin()
	@RequestMapping(value = "/getsubFacility", headers = "Authorization", method = {
			RequestMethod.POST }, produces = { "application/json" })
	public String getsubFacility( @RequestBody String getMainFacility) {
		...
		try {
				...
				M_Facility mainStore = InputMapper.gson().fromJson(getMainFacility, M_Facility.class);
				ArrayList<M_Facility> mainStoreUpdate = storeService.getChildFacility(mainStore.getProviderServiceMapID(),mainStore.getMainFacilityID());
	...
	@CrossOrigin()
	@RequestMapping(value = "/getStoreByID", headers = "Authorization", method = {
			RequestMethod.POST }, produces = { "application/json" })
	...
	@CrossOrigin()
	@RequestMapping(value = "/getVanByStoreID/{storeID}", headers = "Authorization", method = { RequestMethod.POST }, produces = {
			"application/json" })
